...
在 [Netty 源码解析简介](/netty_source_code_parsing/ready_to_go/introduce.html) 一文中，echo 介绍了本教程的教学路线，在本文，我还是相对 Netty 的整体架构脉络进行一个简单的梳理，以助读者对 Netty 整体有清晰的理解

学习任何一门技术都需要有全局观，在开始上手的时候，不宜陷入琐碎的技术细节，避免走进死胡同。这节课我们以 Netty 整体架构设计为切入点，来带你明确学习目标，建立起 Netty 的学习主线，这条主线将贯穿我们整个的学习过程。

本教程以 Netty 4.1.56 为基准版本，我将分别从 Netty **整体结构**、**逻辑架构**、**源码结构 **三个方面对其进行介绍。

## Netty 整体结构

Netty 是一个设计非常用心的**网络基础组件**，Netty 官网给出了有关 Netty 的整体功能模块结构，却没有其他更多的解释。从 [Netty 官网](https://netty.io/)的图中，我们可以清晰地看出 Netty 结构一共分为三个模块：
...
![image-20241029171748005](https://echo798.oss-cn-shenzhen.aliyuncs.com/img/image-20241029171748005.png?x-oss-process=image/watermark,image_aW1nL3dhdGVyLnBuZw==,g_nw,x_1,y_1)
...
![image-20241029155404626](https://echo798.oss-cn-shenzhen.aliyuncs.com/img/image-20241029155404626.png?x-oss-process=image/watermark,image_aW1nL3dhdGVyLnBuZw==,g_nw,x_3,y_3)
...
![1](https://echo798.oss-cn-shenzhen.aliyuncs.com/img/1496926-20190717221051527-1104614478.png?x-oss-process=image/watermark,image_aW1nL3dhdGVyLnBuZw==,g_nw,x_3,y_3)
...
![1231321](https://echo798.oss-cn-shenzhen.aliyuncs.com/img/1231321.png?x-oss-process=image/watermark,image_aW1nL3dhdGVyLnBuZw==,g_nw,x_3,y_3)
...
![image-20241029172517447](https://echo798.oss-cn-shenzhen.aliyuncs.com/img/image-20241029172517447.png?x-oss-process=image/watermark,image_aW1nL3dhdGVyLnBuZw==,g_nw,x_1,y_1)
...
![image-20241029161206900](https://echo798.oss-cn-shenzhen.aliyuncs.com/img/image-20241029161206900.png?x-oss-process=image/watermark,image_aW1nL3dhdGVyLnBuZw==,g_nw,x_1,y_1)
...
![image-20241029161939103](https://echo798.oss-cn-shenzhen.aliyuncs.com/img/image-20241029161939103.png?x-oss-process=image/watermark,image_aW1nL3dhdGVyLnBuZw==,g_nw,x_1,y_1)
...
![image-20241029171155845](https://echo798.oss-cn-shenzhen.aliyuncs.com/img/image-20241029171155845.png?x-oss-process=image/watermark,image_aW1nL3dhdGVyLnBuZw==,g_nw,x_1,y_1)
...
![image-20241029171548553](https://echo798.oss-cn-shenzhen.aliyuncs.com/img/image-20241029171548553.png?x-oss-process=image/watermark,image_aW1nL3dhdGVyLnBuZw==,g_nw,x_1,y_1)
...
![image-20241029171640030](https://echo798.oss-cn-shenzhen.aliyuncs.com/img/image-20241029171640030.png?x-oss-process=image/watermark,image_aW1nL3dhdGVyLnBuZw==,g_nw,x_1,y_1)
...
在我刚开始接触 Netty 时，面对太多的核心组件刚开始是无从下手的，所以在 Netty 的逻辑架构中我梳理了 Netty 中各个核心组件的关系，希望能够帮助你快速入门。